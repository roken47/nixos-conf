...

{
  ...
  # cli / dotfiles stack
  curl                   # download and more
  thefuck                # unfucks commands you misspell or what have you
  zoxide                 # cd replacement, trained by cd
  starship               # cross-platform, cross-shell prompt
  zsh                    # POSIX compliant shell
  nushell                # shell non-POSIX compliant
  helix                  # new fave cli text editor
  git                    # source control
  eza                    # ls replacement
  wget                   # download files
  fortune                # welcome message
  neofetch               # welcome message
  bat                    # cat replacement
  chezmoi                # manage dotfiles
  # favorite applications
  bitwarden              # Password Mgr gui
  bitwarden-cli          # Password Mgr cli
  jellyfin-media-player  # Play my media server
  anytype                # Second Brain
  pocket-casts           # Podcasts
  cider                  # Apple Music
  steam                  # Gaming
  vscode                 # Code Editor
  rio                    # Rust FOSS Terminal
  warp-terminal          # Rust AI-closed Terminal
  # notification daemon
  dunst
  libnotify
  # networking
